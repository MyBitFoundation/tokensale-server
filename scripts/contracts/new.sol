...
contract Crowdsale is owned{
	...
	uint public constant presaleDuration = 61 days;
	uint public constant saleDuration = 30 days;
	...
	address _bounties
		...
		presaleDeadline = now + presaleDuration;
		deadline = now + presaleDuration + saleDuration;
